...
'''
python 提供了2个级别访问的网络服务
低级别的网络服务支持基本的socket，它提供了标准的BSD Sockets API，裤腰访问底层操作系统Socket接口的全部方法
高级别的网络服务模块SocketServer，它提供了服务器中心类，裤腰简化网络服务器的开发
'''

print('''
Socket是套接字，应用程序通常通过套接字向网络发出请求或者应答网络请求，使主机间或一台计算机上的进程间裤腰互相通信
''')
